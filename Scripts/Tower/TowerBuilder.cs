...
public class TowerBuilder : MonoBehaviour
{
    ...
    public List<Block> Build()
    {
        ...
        for (int i = 0; i < _towerSize; i++)
        {
            ...
            newBlock.SetColour(_colors[Random.Range(0, _colors.Length)]);
    ...
    private Vector3 GetBuildPoint(Transform curentSegment)
    {
        return new Vector3(_buildPoint.position.x, curentSegment.position.y + curentSegment.localScale.y/ 2 + _block.transform.localScale.y/2, _buildPoint.position.z);
    }
}
